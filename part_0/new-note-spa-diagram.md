```mermaid
    sequenceDiagram
        ...
        Note over Browser: En el documento spa.js el controlador de eventos \n crea una nueva nota, la agrega a la lista de notas \n y vuelve a renderizar la lista en la página y \n envía la nueva nota al servidor
