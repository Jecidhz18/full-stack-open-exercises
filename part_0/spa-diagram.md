```mermaid
    sequenceDiagram
        ...
        Note over Browser: Se carga la página /spa que genera \n tres solicitudes HTTP
        Browser->>Server: GET https://studies.cs.helsinki.fi/exampleapp/main.css
        Server-->>Browser: Hoja de estilos main.css
        Browser->>Server: GET https://studies.cs.helsinki.fi/exampleapp/spa.js
        Server-->>Browser: Código JavaScript spa.js
        Note over Browser: Se ejecuta el código js que solicita las \n notas en formato json al servidor
